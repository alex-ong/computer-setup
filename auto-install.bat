...
rem winget install --id=Microsoft.VisualStudio.Community -e
rem winget install --id=Microsoft.VisualStudio.Professional -e
winget install --id=Microsoft.VisualStudioCode -e

rem You can remove /silent below to choose options manually
winget install --id Git.Git -e --override "/VERYSILENT /COMPONENTS=icons,assoc,assoc_sh"
...
winget install --id=dotPDN.PaintDotNet --installer-type wix
...
mkdir c:\python314
winget install --id=python.python.3.14 --override "installallusers=1 targetdir=c:\python314 defaultcustomtargetdir=c:\python314 prependpath=1 compileall=1"
...
rem winget install -e --id Obsidian.Obsidian
